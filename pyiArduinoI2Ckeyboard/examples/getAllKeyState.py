...
#  Выполняем действия по изменению состояния любой клавиши:        #
    if kbd.getKey(KEY_ALL, KEY_CHANGED):                         #   Если изменилось состояние хотя бы одной кнопки, то ...
        ...
        if i & (1<<1): print("1,", end='')                          #   Если установлен 0 бит (флаг состояния 1 кнопки 1 ряда), то выводим текст.
        if i & (1<<2): print("2,", end='')                          #   Если установлен 1 бит (флаг состояния 2 кнопки 1 ряда), то выводим текст.
        if i & (1<<3): print("3,", end='')                          #   Если установлен 2 бит (флаг состояния 3 кнопки 1 ряда), то выводим текст.
        if i & (1<<4): print("4,", end='')                          #   Если установлен 3 бит (флаг состояния 4 кнопки 1 ряда), то выводим текст.
        if i & (1<<5): print("5,", end='')                          #   Если установлен 4 бит (флаг состояния 1 кнопки 2 ряда), то выводим текст.
        if i & (1<<6): print("6,", end='')                          #   Если установлен 5 бит (флаг состояния 2 кнопки 2 ряда), то выводим текст.
        if i & (1<<7): print("7,", end='')                          #   Если установлен 6 бит (флаг состояния 3 кнопки 2 ряда), то выводим текст.
        if i & (1<<8): print("8,", end='')                          #   Если установлен 7 бит (флаг состояния 4 кнопки 2 ряда), то выводим текст.
        print()                                        #
                                                                   #
#  ПРИМЕЧАНИЕ:                                                     #
